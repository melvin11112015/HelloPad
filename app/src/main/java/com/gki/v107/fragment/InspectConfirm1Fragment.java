 ...
 */
public class InspectConfirm1Fragment extends Fragment {
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.button2_inspection1_check:
                    acquireDatas(etOrderno.getText().toString());
                    break;
                case R.id.button2_inspection1_submit:
                    submitDatas(adapter.createAddonList(tvstarttime.getText().toString(),tvendtime.getText().toString(),tvDate.getText().toString()));
                    break;
    ...
    private void acquireDatas(String orderno){

        if(orderno.isEmpty())return;

        String filter = "Prod_Order_No eq '" + orderno +"'";
    ...
    private void submitDatas(final List<ProdConfirmBomItemsAddon> addons){
    ...
    private static class MyInspectionAdapter extends BaseQuickAdapter<WebPordOrderCompInfo,BaseViewHolder>{
        ...
        protected void convert(BaseViewHolder helper, WebPordOrderCompInfo item) {
            helper.setText(R.id.tv2_item_inspection1_no,String.valueOf(helper.getAdapterPosition()+1));
        ...
        public List<ProdConfirmBomItemsAddon> createAddonList(String starttime,String endtime,String date){
            ...
            for(int index = 0;index<data.size();index++) {
                ...
                CheckBox checkBox =((CheckBox)getViewByPosition(getRecyclerView(),index,R.id.checkbox2_item_inspection1_confirm));
                boolean isConfirmed =checkBox!=null && checkBox.isChecked();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        etOrderno = (EditText) view.findViewById(R.id.et2_inspection1_pno);
        ...
        view.findViewById(R.id.button2_inspection1_check).setOnClickListener(onClickListener);
        view.findViewById(R.id.button2_inspection1_submit).setOnClickListener(onClickListener);
